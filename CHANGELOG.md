* v2.22.0
- Adds the ability to track Core Web Vitals when the `trackCoreWebVitals` option is enabled. This also ensures that First Input Delay is reported from Firefox sessions.
