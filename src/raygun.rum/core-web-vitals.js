...
function raygunCoreWebVitalFactory(window) {
    ...
    CoreWebVitals.prototype.attach = function(queueHandler, parentResourceHash) {
        queueTimings = queueHandler;
        _parentResourceHash = parentResourceHash;
    ...
    CoreWebVitals.prototype.handler = function(event) {
        ...
        var webVitalEvent = {
            ...
            parentResourceHash: _parentResourceHash
        };
